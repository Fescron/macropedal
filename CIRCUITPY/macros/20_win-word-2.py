...
app = {                              # REQUIRED dict, must be named 'app'
    ...
    'macros' : [                     # List of button macros...
        ...
        (0x202000, '-Size3',  [Kc.CONTROL, Kc.SHIFT, '>', -Kc.CONTROL, -Kc.SHIFT, Kc.CONTROL, Kc.SHIFT, '>',
                               -Kc.CONTROL, -Kc.SHIFT, Kc.CONTROL, Kc.SHIFT, '>', -Kc.CONTROL, -Kc.SHIFT]), # Decrease text size (3x)
        # Encoder button ---
        (0x000000, '',        [])
    ]
}
