...
app = {                              # REQUIRED dict, must be named 'app'
    ...
    'macros' : [                     # List of button macros...
        ...
        (0x000020, '%Poly',   [Kc.ESCAPE, 0.05, -Kc.ESCAPE, 0.05, Kc.ESCAPE, 0.05, -Kc.ESCAPE, 0.05, Kc.ALT, 0.05, -Kc.ALT, 't', 0.05, 'g', 0.05, 'o']), # Tools > Polygon Pours > Repour Modified
        # 2nd row ----------
        ...
        # 4th row ----------
        (0x002020, 'Region',  [Kc.ESCAPE, 0.05, -Kc.ESCAPE, 0.05, Kc.ESCAPE, 0.05, -Kc.ESCAPE, 0.05, Kc.ALT, 0.05, -Kc.ALT, 'p', 0.05, 'r']), # Place > Solid Region
