...
app = {                              # REQUIRED dict, must be named 'app'
    ...
    'macros' : [                     # List of button macros...
        ...
        (0x002000, '+DrwPa',  [Kc.ALT, 'n', -Kc.ALT, '0', 'n', 0.5, Kc.ALT, 'jd', 'ap', 'g', -Kc.ALT, 0.5, Kc.ALT, 'jd', 'xt', 'k']), # Invoegen > Vormen > Nieuw tekenpapier # Vormindeling > Vormopvulling > Geen opvulling # Vormindeling > Tekstterugloop > Voor tekst
